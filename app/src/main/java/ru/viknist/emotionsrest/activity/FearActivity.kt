...
class FearActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val continueButton = findViewById<TextView>(R.id.continueFearTextView)
        val fearEditText = findViewById<EditText>(R.id.fearEditText)
        val userInfo =
        ...
        continueButton.setOnClickListener {
            lifecycleScope.launch {
                try {
                    val emotionModel = EmotionModel(fearEditText.text.toString(), "scared")
