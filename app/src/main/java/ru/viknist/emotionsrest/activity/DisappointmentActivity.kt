...
class DisappointmentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val continueButton = findViewById<TextView>(R.id.continueDisappointmentTextView)
        val disappointmentEditText = findViewById<EditText>(R.id.disappointmentEditText)
        val userInfo =
        ...
        continueButton.setOnClickListener {
            lifecycleScope.launch {
                try {
                    val emotionModel = EmotionModel(disappointmentEditText.text.toString(), "disappointed")
